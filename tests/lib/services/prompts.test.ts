...
describe("questionPromptBuilders", () => {
  describe("multiple_choice", () => {
    it("should generate system prompt", () => {
      const systemPrompt = questionPromptBuilders.multiple_choice.system();
  ...
  describe("open_question", () => {
    it("should generate system prompt", () => {
      const systemPrompt = questionPromptBuilders.open_question.system();
  ...
  describe("code_snippet", () => {
    it("should generate system prompt", () => {
      const systemPrompt = questionPromptBuilders.code_snippet.system();
